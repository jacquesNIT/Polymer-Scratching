...
def _is_design_header(head):
    head = (head or "").strip()
    if not head.startswith("#"):
        return False
    if head.startswith(DESIGN_HINTS):
        return True
    return "design" in head.lower() and "generated by" in head.lower()
...
def main(argv=None):
    ...
    if design_path:
        ...
        print("\n!! No design file: figures 01 (campaign map) and 05 (QoI vs\n"
              ...
              "   (e.g. --design designs/glassy_pmma_calib.csv).\n")
