...
def _glassy_pmma_config():
    ...
    cfg.material = Material_Config(
        ...
        friction=Friction_Config.briscoe(tau0=20.0, alpha=0.1),                   # Originally (4,0.2), tested (25,0.1) and (40,0.05) for calibration                                         # Plausible value for tau0 and alpha, to be determined
        #friction=Friction_Config(mu=0.3),
        family="glassy_pmma",
    )
    cfg.solver.target_time_increment = 60.0 * natural_dt(cfg.material, cfg.mesh.fine_size_x) 
