...
def _glassy_config():
    ...
    cfg.solver.mass_scale = 20000        
    #cfg.solver.target_time_increment = 60.0 * natural_dt(cfg.material, cfg.mesh.fine_size_x) # 15 : Same as PC
    return cfg
...
def _glassy_pmma_config():
    ...
    cfg.material = Material_Config(
        ...
        plasticity=DruckerPrager_Config(
            friction_angle=25.0, flow_stress_ratio=1.0, dilation_angle=10.0,      # dilation_angle = 10 originally, 5 or 0 for calibration tests
        ...
        friction=Friction_Config.briscoe(tau0=40.0, alpha=0.05),                   # Originally (4,0.2), tested (25,0.1) and (40,0.05) for calibration                                         # Plausible value for tau0 and alpha, to be determined
        #friction=Friction_Config(mu=0.3),
        family="glassy_pmma",
    )
    cfg.solver.target_time_increment = 60.0 * natural_dt(cfg.material, cfg.mesh.fine_size_x) 
