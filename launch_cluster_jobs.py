...
JOBS = [
    ...
    ("design", "glassy_pc", {"tag": "Morris1_001", "ALE": True, "scratch_time": 0.01, "distortion": False,"unload_time": 0.005,"recovery_time": 0.005}), 
...
DESIGN_JOBS = 8                  # number of jobs for the "design" sweep
