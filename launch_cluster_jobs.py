...
_VALID_FAMILIES = ("elastomer_mr", "elastomer_ve", "semicrystalline_j2", "semicrystalline_dp", "glassy_dp", "glassy_pc", "glassy_pmma", "glassy_pmma_calib", "glassy_pc_calib")
...
_OVERRIDE_ALIASES = {
    ...
    # Intercepted in run_parameter_study._apply_overrides 
